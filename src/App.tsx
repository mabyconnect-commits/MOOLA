...
export default function App() {
  ...
  return (
    <div style={css('min-height:100vh;display:flex;justify-content:center;background:#05060d;font-family:Sora,sans-serif')}>
      <div style={css('position:relative;width:440px;max-width:100vw;min-height:100vh;overflow:hidden;color:#eafff4;background:radial-gradient(130% 80% at 50% -10%, #123a2a 0%, #0a1d14 42%, #06110b 100%)')}>
        {/* ambient glow blobs */}
